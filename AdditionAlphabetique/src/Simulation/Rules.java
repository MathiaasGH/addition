...
public class Rules{
	...
	protected static final double goodRule = 0.3; // ESTIMATION ✅
	protected static final double malRule = -1; // ESTIMATION ✅
	
	private static final Rules instance = new Rules(goodRule, malRule);
