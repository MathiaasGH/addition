...
public class parametersInstructed_5{
	...
	public static void main(String[] args) {
		...
		String csvFile = "estimationInstructed5.csv";
...
//				for(double decisionDeterminism=0.5; decisionDeterminism<=1.5; decisionDeterminism=Math.round((decisionDeterminism+0.1)*10.0)/10.0) {
				for(double decisionDeterminism=1.3; decisionDeterminism<=1.4; decisionDeterminism=Math.round((decisionDeterminism+0.1)*10.0)/10.0) {
