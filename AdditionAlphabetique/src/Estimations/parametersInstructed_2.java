...
public class parametersInstructed_2{
	...
	public static void main(String[] args) {
		...
		String csvFile = "estimationInstructed2.csv";
...
//				for(double decisionDeterminism=0.5; decisionDeterminism<=1.5; decisionDeterminism=Math.round((decisionDeterminism+0.1)*10.0)/10.0) {
				for(double decisionDeterminism=0.7; decisionDeterminism<=0.8; decisionDeterminism=Math.round((decisionDeterminism+0.1)*10.0)/10.0) {
