...
public class parametersInstructed_4{
	...
	public static void main(String[] args) {
		...
		String csvFile = "estimationInstructed4.csv";
...
//				for(double decisionDeterminism=0.5; decisionDeterminism<=1.5; decisionDeterminism=Math.round((decisionDeterminism+0.1)*10.0)/10.0) {
				for(double decisionDeterminism=1.1; decisionDeterminism<=1.2; decisionDeterminism=Math.round((decisionDeterminism+0.1)*10.0)/10.0) {
