...
public class est_mathias_NCSC extends paramEstimation{

	public String nameNewFile;
	public String nameCSVfile;

	public void run() {
		augendList = "a,c,e,g,i,k";
		addendList = "2,3,4,5";
		...
		// Paramètres
		double[] inP = new double[]{.4,.45,.5,.55,.6,.65};
		double[] tTab = new double[]{3000};
		double[] pTab = new double[]{30};
		double[] bTab = new double[]{700};
		double[] dTab = new double[]{325};
		double[] rationalityTab = new double[]{0.0015, .002,.003,.004,.005,.006};
		double[] countingReinforcement = new double[]{.3,.35,.4,.45,.5,.55,.6,.65};
		double[] retrievingReinforcement = new double[]{.5,.55,.6,.65,.7};
	...
	public static void main(String[] args) {
		est_mathias_NCSC instance = new est_mathias_NCSC();
		instance.nameCSVfile="productionEmpiriques.csv";
		instance.nameNewFile="NCSC";
		instance.run();
